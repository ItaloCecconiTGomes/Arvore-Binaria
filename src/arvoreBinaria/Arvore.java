...
public class Arvore <TIPO extends Comparable>{
	...
	private Elemento <TIPO> raiz; //TIPO pois é uma árvore genérica, pode armazenar qualquer tipo de dado
